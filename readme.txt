...
and register it with your request:cccc

var request = new RestRequest(Method.POST){JsonSerializer= new YourCustomSerializer()} 

The default Json*Deserializer* should be 100% compatible.

If you run into any compatibility issues with deserialization, 
please report it to http://groups.google.com/group/restsharp   dfadsfddddd